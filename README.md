...
[![Version](https://img.shields.io/badge/version-1.2.0-2ea44f?style=flat-square)](https://github.com/1449690477/SusuAIOverclock/releases)
...
从 [Releases](https://github.com/1449690477/SusuAIOverclock/releases) 下载 `SusuAIOverclock-1.2.0-portable.exe`，双击即用，免安装。
...
```bat
:: 直接指定根目录，跳过对话框
SusuAIOverclock-1.2.0-portable.exe --root "C:\path\to\packs"
